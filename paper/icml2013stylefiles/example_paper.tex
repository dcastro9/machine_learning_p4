...
\icmltitlerunning{Analysis of Markov Decision Processes (MDP) using Q-Learning}

\begin{document} 

\twocolumn[
\icmltitle{Analysis of Markov Decision Processes (MDP) using Value Iteration, \\
...
% package.
\icmlauthor{Your Name}{dcastro9@gatech.edu}
\icmladdress{Georgia Institute of Technology,
            336026 Georgia Tech Station, Atlanta, GA USA}

% You may provide any keywords that you 
% find helpful for describing your paper; these are used to populate 
% the "keywords" metadata in the PDF but will not be shown in the document
\icmlkeywords{machine learning, mdp, value iteration, policy iteration, q-learning}

\vskip 0.3in
]

\begin{abstract} 
This paper covers an analysis of Pacman and Gridworld, two Markov Decision
Processes (MDP), through the use of value iteration, policy iteration, and
Q-Learning. We focus specifically on numerous iterations of Gridworld in order
to investigate the relationship between performance and grid size, and consider
multiple exploration strategies in order to assess their performance.
\end{abstract} 
